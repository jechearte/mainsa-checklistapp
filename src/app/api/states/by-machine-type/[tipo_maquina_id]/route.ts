...
export async function GET(
  ...
  try {
    ...
    const statesUrl = `${apiUrl}/api/states/by-machine-type/${tipoMaquinaId}/`;
    
    console.log('Haciendo petición a:', statesUrl);
    ...
    console.log('Respuesta exitosa de estados:', {
    ...
    console.error('Error en GET /api/states/by-machine-type:', error);
